...
export default function Lista() {
    ...
    setFilteredData([
      ...data.filter(
        (e) =>
          ...
          e.modelo.toLowerCase().includes(modelo.toLowerCase())
      ),
    ]);
  ...
  return (
    <>
      <div className="border border-black bg-gray-950 bg-opacity-50 text-white pb-12 px-12 flex flex-col gap-8">
