...
export default function ConsultaEstoque() {
	...
	const [car1, setCar1] = useState(Math.floor(Math.random() * 800));
	const [car2, setCar2] = useState(Math.floor(Math.random() * 800));
	const [car3, setCar3] = useState(Math.floor(Math.random() * 800));
